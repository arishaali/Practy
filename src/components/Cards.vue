<template>
        ...
        >
          ...
          <div class="flex justify-between">
            <h3 data-test="card" class="font-bold text-base md:text-2xl">{{ card.heading }}</h3>
          ...
          <div class="flex justify-between items-center md:space-x-20">
            ...
            <div class="mx-auto rounded-lg text-white  text-center">
              <div :class="[parseInt(card.rating) > 5 ? 'bg-green-400' : 'bg-red-500']" class="h-10 w-10 flex items-center justify-center mx-auto rounded-lg text-white" >
                {{ card.rating }}
              </div>
              </div>
